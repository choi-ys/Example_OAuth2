...
import io.example.authorization.domain.dto.response.partner.ClientAdapter;
import io.example.authorization.domain.dto.response.partner.PartnerAdapter;
...
public class PartnerService implements UserDetailsService, ClientDetailsService {
    ...
    public UserDetails loadUserByUsername(String partnerId) throws UsernameNotFoundException {
        ...
        /**
         * Srping security의 User객체를 이용하여 PartnerEntity객체를 UserDetails 객체로 변환
         ...
         */
        return new PartnerAdapter(partnerEntity);
    }
    ...
    public ClientDetails loadClientByClientId(String clientId) throws ClientRegistrationException {
        ClientEntity clientEntity = this.clientRepository.findById(clientId)
                ...
                ;
        return new ClientAdapter(clientEntity);
    }
}
